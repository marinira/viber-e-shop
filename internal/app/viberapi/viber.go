...
func NewViber() *Viber {
	...
	vb.Uri = "https://e85f55a1.ngrok.io"
	vb.AppKey = "4b68a18eb467de54-d172c022a32710b4-80dd0e9383884798"
	vb.Sender = Sender{
		Name:   "MyPage",
		Avatar: vb.Uri + "avatar.jpg",
	}
	vb.client = &http.Client{}

	vb.Message = MyMsgReceivedFunc // your function for handling messages
	vb.Delivered = MyDeliveredFunc // your function for delivery report
	vb.ConversationStarted = MyConversationStarted
	vb.Seen = MySeenFunc
	// Subscribed          func(v *Viber, u User, token uint64, t time.Time)
	// Unsubscribed        func(v *Viber, userID string, token uint64, t time.Time)
	vb.Failed = MyFailed
