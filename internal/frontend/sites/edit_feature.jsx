...
import UnitsQueue from '../features/units_queue';
...
import FindNature from '../features/find_nature';
import FindInactive from '../features/inactive_finder';
	...
	render({ }, { ident, name, long_description }) {
		...
		switch (ident) {
			...
			case 'queue':
				...
				break;
			case 'units':
				feat = <UnitsQueue feature={ this.state } submit={ this.submit } delete={ this.delete } />;
				break;
			case 'raise_fields':
			...
			case 'timed_attack':
				...
				break;
			case 'find_nature':
				feat = <FindNature feature={ this.state } submit={ this.submit } delete={ this.delete } />;
				break;
			case 'inactive_finder':
				console.log('FindInactive');
				console.log(this.state);
				feat = <FindInactive feature={ this.state } submit={ this.submit } delete={ this.delete } />;
				break;
		}
