						...
						<div class="navbar-start">
							...
							<div class="navbar-item has-dropdown is-hoverable">
								...
								<div class="navbar-dropdown is-radiusless">
									...
									<a className="navbar-item" onClick={ e => this.get_new('units') }>
										units queue
									</a>
									...
									<a className="navbar-item" onClick={ e => this.get_new('find_nature') }>
										Find nature
									</a>
									<a className="navbar-item" onClick={ e => this.get_new('inactive_finder') }>
										Inactive finder
									</a>
								</div>
							</div>
